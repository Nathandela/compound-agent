...
describe('Setup Commands - Generated Content', () => {
  ...
  describe('setup --update', () => {
    it('overwrites generated files (with marker) with latest templates', async () => {
      ...
      // Agent file has marker (from legacy install), should be overwritten
      ...
      // --update still uses GENERATED_MARKER in all.ts (not modified)
  ...
  describe('Workflow command template installation', () => {
    it('creates .claude/commands/compound/ with 11 .md files', async () => {
      runCli('init');

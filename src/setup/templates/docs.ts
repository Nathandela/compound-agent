...
- **Semantic embeddings** (nomic-embed-text-v1.5 via Transformers.js) for vector similarity search
...
\`setup\` does everything \`init\` does, plus downloads the nomic-embed-text-v1.5 model via Transformers.js. Use \`--skip-model\` to skip the download.

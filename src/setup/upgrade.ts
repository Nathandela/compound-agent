...
/** CLI wrapper commands deprecated in v1.3+. learn.md replaced by learn-that.md in v1.4. brainstorm.md renamed to spec-dev.md in v1.5. */
const DEPRECATED_COMMANDS = ['search.md', 'list.md', 'show.md', 'stats.md', 'wrong.md', 'learn.md', 'brainstorm.md'];

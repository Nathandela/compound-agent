...
const nativeFiles = [
  ...
  'src/memory/retrieval/unified-retrieval.test.ts',
  'src/memory/search/prewarm.test.ts',
  'src/memory/search/unified-search.test.ts',
  'src/memory/search/vector.test.ts',
  'src/memory/storage/compact.test.ts',
  'src/memory/storage/sqlite.test.ts',
  'src/memory/storage/sqlite/barrel-exports.test.ts',
  'src/memory/storage/sqlite/cache.test.ts',
  'src/memory/storage/sqlite/connection.test.ts',
  'src/memory/storage/sqlite/read-all.test.ts',
  'src/memory/storage/sqlite/search.test.ts',
  'src/memory/storage/sqlite/unified-memory.test.ts',
  'src/memory/knowledge/embed-background.test.ts',
